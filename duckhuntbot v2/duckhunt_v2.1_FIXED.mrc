; mIRC DuckHunt Auto-Reply Script v2.1
; LIMITED TO CHANNEL: #url
; Auto buy-back gun feature included
; FIXED: Inventory parsing
...
on *:TEXT:*:#url:{
  ...
  ; Parse duckstats to check inventory - FIXED PARSING
...
echo -a *** DuckHunt Auto-Reply Script Loaded (v2.1)
