; ============================================================
; DuckHunt Auto-Shooter Script v4.0
...
; ============================================================
; Decoy detection — exact bot phrase only, no loose matching
; If your bot uses a different phrase, add it as a new block
; following the same pattern below
; ============================================================
on *:TEXT:*DECOY DUCK*:#:{
  if (!$duck_chans($chan))  { halt }
  if (!$duck_isbot($nick))  { halt }
