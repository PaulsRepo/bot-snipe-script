; ============================================================
; DuckHunt Auto-Shooter Script v3.5
...
on *:TEXT:*QUACK!*:#:{
  ...
  var %tn = duck_ $+ $chan
  .timer %tn 1 %delay msg $chan !bang
...
on *:TEXT:*out of ammo*:#:{
  ...
  var %tnR = duckR_ $+ $chan
  var %tnB = duck_ $+ $chan
  .timer %tnR 1 2 msg $chan !reload
  .timer %tnB 1 4 msg $chan !bang
}
...
on *:TEXT:*DECOY DUCK*:#:{
  ...
  var %tnD = duckD_ $+ $chan
  .timer %tnD 1 %delay msg $chan !befriend
